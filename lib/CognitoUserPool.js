...
var CognitoUserPool = function () {
  ...
  function CognitoUserPool(data) {
    ...
    console.log(_awsSdk2.default.config.credentials);
    /**
  ...
  */
  ...
  CognitoUserPool.prototype.adminCreateUser = function adminCreateUser(username, password, userAttributes, validationData, credentials, callback) {
    var _this2 = this;
    ...
    this.client.adminCreateUser(jsonReq, function (err, data) {
      if (err) {
        return callback(err, null);
      }
